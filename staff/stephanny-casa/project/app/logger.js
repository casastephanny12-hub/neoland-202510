class Logger {
    ...
    debug(message) {
        this.level <= Logger.DEBUG && console.debug('%cDEBUG ' + message, 'font-weight: bold; color: lightblue;')
    }

    info(message) {
        this.level <= Logger.INFO && console.info('%cINFO ' + message, 'font-weight: bold; color: green;')
    }
    warn(message) {
        this.level <= Logger.WARN && console.warn('%cWARN ' + message, 'font-weight: bold; color: orange;')
    }
