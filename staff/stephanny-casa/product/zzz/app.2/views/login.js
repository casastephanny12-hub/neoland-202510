...
setClass(loginUsernameInput, 'border-2 boder-solid border-black rounded-lg p-1')
...
setClass(loginPasswordInput, 'border-2 boder-solid border-black rounded-lg p-1')
...
setClass(loginShowPasswordButton, 'border-3 rounded-sm border-solid border-orange-500 bg-orange-200 self-end')
...
loginShowPasswordButton.addEventListener('click', function (event) {
    ...
    if (getType(loginPasswordInput) === 'password') {
        ...
        setClass(loginShowPasswordButton, 'border-3 rounded-sm border-solid border-orange-500 self-end')
    } else {
        setType(loginPasswordInput, 'password')
        setTextContent(loginShowPasswordButton, 'Show')
        setClass(loginShowPasswordButton, 'border-3 rounded-sm border-solid border-orange-500 self-end')
...
setClass(loginRegisterLink, 'underline decoration-orange-500')
