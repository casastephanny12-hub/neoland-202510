...
function createTitle(){
    ...
    setClass(title, 'font-bold text-4xl my-4')
...
function createLink(){
    ...
    setClass(link, 'cursor-pointer bg-orange-300 rounded-sm border-2 border-black p-1 my-6 self-end')
...
function createButton(){
    ...
    setClass(button, 'border-3 rounded-sm border-solid border-orange-500 bg-orange-200 self-center')
