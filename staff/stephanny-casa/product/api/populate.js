...
const campanilla = new UserModel ({ name: 'Campanilla', email: 'campa@nilla.com', username: 'campanilla', password: '12345678'})

const mickey = new UserModel ({ name: 'Mickey Mouse', email: 'mickey@mouse.com', username: 'mickeymouse', password: '12345678' })

const woody = new UserModel ({ name: 'Woody', email: 'sheriff@woody.com', username: 'woody', password: '12345678'})

const buzz = new UserModel ({ name: 'Buzz', email: 'buzz@lightyear.com', username: 'buzzlightyear', password: '12345678'})

Promise.all([wendy.save(), peter.save(), campanilla.save(), mickey.save(), woody.save(), buzz.save() ])
